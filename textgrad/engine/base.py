...
class EngineLM(ABC):
    ...
    model_string: str
    @abstractmethod
    def generate(self, prompt, system_prompt=None, temperature = 0, **kwargs):
        pass
...
class CachedEngine:
    ...
    def _check_cache(self, prompt: str, num_evals = 5):
        if prompt in self.cache:
            return self.cache[prompt]
        else:
            return None

    def _save_cache(self, prompt: str, response: str, num_evals = 5):
