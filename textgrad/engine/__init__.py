...
def get_engine(engine_name: str, temperature = 0, **kwargs) -> EngineLM:
    ...
    if engine_name.startswith("azure"):
        ...
        return ChatOpenAI(model_string=engine_name, is_multimodal=_check_if_multimodal(engine_name), temperature=temperature, **kwargs)
