...
class HumanEval(Dataset):
    def __init__(self, root: str = None):
        ...
        #print('in human eval')
        self.root = root
        data_path = f"/Users/bhrijpatel/Desktop/textgrad/HumanEval_clean.jsonl"
        #self._check_or_download_dataset()
        ...
        self._task_description = 'You will solve a hard coding problem from HumanEval dataset. You will be given a prompt describing a problem. You need to write a function that passes all the tests.'
